...
//if (undefined == Array.slice) { // mozilla already defines this
...
define(String, 'strip', function() {
    ...
    var ws = " \t\n\r";
    for (var j = this.length; --j >= 0 && ws.indexOf(this.charAt(j)) >= 0; )
        ;
    for (var i = 0; i < j && ws.indexOf(this.charAt(i)) >= 0; i++)
        ;
